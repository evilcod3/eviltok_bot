# Copyright 2021 Eviltok_bot under the terms of the HARV
# license found at https://github.com/evilcod3/eviltok_bot/blob/master/LICENSE
# Encoding = 'utf-8'
# Fork and Deploy, do not modify this repo and claim it yours
# For collaboration mail me at evilcode.pentest@gmail.com
...
load_dotenv()
bot_token = os.environ.get('6854037564:AAHGH2Q_Y58zKRA43PqPUzDOc0HIi7NtfBI')
workers = int(os.environ.get('4'))
api = int(os.environ.get('10205722'))
hash = os.environ.get('d3aa6c784f23c134af43c75db08611ec')
chnnl = os.environ.get('https://t.me/evilcod3')
BOT_URL = os.environ.get('https://t.me/eviltok_bot')
app = Client("evilcode", bot_token=bot_token, api_id=api, api_hash=hash, workers=workers)



@app.on_message(filters.command('start'))
def start(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Repo 🔰', url="https://github.com/Evilcod3/eviltok_bot/")]]
    reply_markup = InlineKeyboardMarkup(kb)
    app.send_message(chat_id=message.from_user.id, text=f"Hello there, I am **AI Bot**.\nI can help you in your work tasks.\n\n"
                          "__**Developer :**__ __@evilcode__\n"
...
def help(client, message):
    kb = [[InlineKeyboardButton('Channel 🛡', url=chnnl),InlineKeyboardButton('Repo 🔰', url="https://github.com/evilcod3/eviltok_bot/")]]
    reply_markup = InlineKeyboardMarkup(kb)
    app.send_message(chat_id=message.from_user.id, text=f"Hello there, I am **AI Bot**.\nI can help you in your work tasks link.\n\n"
